...
public class SlimeDebuff_My : MonoBehaviour
{
	[HideInInspector] EnemyAttack_My targetAttack;		//Reference to the enemy's attack script
	[HideInInspector] EnemyHealth_My targetHealth;		//Reference to the enemy's health script
	...
	public void AttachToEnemy(EnemyAttack_My enemy)
	{
		//Set the targetAttack variable to the provided enemy
		targetAttack = enemy;
		//Get a reference to the enemy's health
		targetHealth = targetAttack.GetComponent<EnemyHealth_My>();
